...
public class QuarkApi {
    ...
    private Object[] getM3u8(String url, Map header) {
        try {
            ...
            return new Object[]{result.code, contentType, new ByteArrayInputStream(m3u8Str.getBytes(StandardCharsets.UTF_8)), respHeaders};
        } catch (Exception e) {
    ...
    private void initUserInfo() {
        try {
            ...
            HttpResult result = doGet("https://pan.quark.cn/account/info?st=" + token + "&lw=scan", new HashMap<>(), getWebHeaders());
