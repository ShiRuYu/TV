...
public class Ali extends Spider {
    ...
    public static final String defaultPicUrl = "https://inews.gtimg.com/newsapp_bt/0/13263837859/1000";
    ...
    public String detailContentVodPlayFrom(List<String> ids) {
        ...
        if (ids.size() < 2) return StringUtils.join(Arrays.asList("轉存原畫"/*, "分享原畫", "代理普畫"*/), "$$$");
